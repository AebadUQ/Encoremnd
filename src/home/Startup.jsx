...
import Hed from "../component/header/hed";
import FooterTwo from "../component/footer/FooterTwo";import { Parallax } from "react-parallax";
const image1 =
  "/assets/images/bg/bg_image--13.jpg";
const SlideList = [
    {
    ...
    render(){
        ...
        return(
            <Fragment> 
                ...
                <Hed headertransparent="header--transparent" colorblack="color--black" logoname="logo.png" />
                ...
                {/* <div className="rn-counterup-area pt--25 pb--110 bg_color--1" >
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="section-title text-center" style={{marginTop:'2%'}}>
