                        ...
                        <div className="col-lg-12">
                            <div className="tablist-inner">
                                <TabList className="pv-tab-button text-center mt--0" >
                                    <Tab><span style={{color:'white'}}>All Project</span></Tab>
                                    <Tab><span style={{color:'white'}}>Web Design</span></Tab>
                                    <Tab><span style={{color:'white'}}>Logo & Graphic Design</span></Tab>
                                    <Tab><span style={{color:'white'}}>Interior Design</span></Tab>
                                </TabList>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div onClick={() => this.setState({ isOpen: true, tab1: index })}>
                                        <div className="portfolio-static">
                                            ...
                                            <div className="content">
                                                <div className="inner">
                                                    <p style={{color:'white'}}>{value.category}</p>
